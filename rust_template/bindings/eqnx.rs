...
pub const BACKGROUND: u32 = 4280098849;
pub const FOREGROUND: u32 = 4292132504;
pub const BLACK: u32 = 4278190080;
pub const GRAY: u32 = 4287791988;
pub const RED: u32 = 4293552482;
pub const GREEN: u32 = 4289312357;
pub const YELLOW: u32 = 4293364302;
pub const BLUE: u32 = 4286426787;
pub const MAGENTA: u32 = 4292052635;
pub const CYAN: u32 = 4287214722;
pub const WHITE: u32 = 4292724641;
pub const TRANSPARENT: u32 = 0;
pub const PLUG_H_: u32 = 1;
pub const __bool_true_false_are_defined: u32 = 1;
pub const true_: u32 = 1;
pub const false_: u32 = 0;
pub const EVENT_H_: u32 = 1;
pub const KEYPRESS_H_: u32 = 1;
...
pub const XKB_KEY_dead_apostrophe: u32 = 65166;
...
pub const XKB_KEY_SSHARP: u32 = 16785054;
pub const XKB_KEY_leftsingleanglequotemark: u32 = 16785465;
pub const XKB_KEY_rightsingleanglequotemark: u32 = 16785466;
...
pub const XKB_KEY_XF86ElectronicPrivacyScreenOn: u32 = 268964434;
pub const XKB_KEY_XF86ElectronicPrivacyScreenOff: u32 = 268964435;
pub const XKB_KEY_XF86ActionOnSelection: u32 = 268964436;
pub const XKB_KEY_XF86ContextualInsert: u32 = 268964437;
pub const XKB_KEY_XF86ContextualQuery: u32 = 268964438;
...
pub const KEY_ACTION_ON_SELECTION: u32 = 596;
pub const KEY_CONTEXTUAL_INSERT: u32 = 597;
pub const KEY_CONTEXTUAL_QUERY: u32 = 598;
...
pub const ABS_SND_PROFILE: u32 = 34;
...
pub const SND_PROFILE_SILENT: u32 = 0;
pub const SND_PROFILE_VIBRATE: u32 = 1;
pub const SND_PROFILE_RING: u32 = 2;
pub const WINDOW_H_: u32 = 1;
...
unsafe extern "C" {
    pub static COLORS: [u32; 11usize];
}
pub type Esx_Program = Esx_Token;
unsafe extern "C" {
    pub fn esx_to_args(
        program: Esx_Program,
        e_argc: *mut ::std::os::raw::c_int,
        e_argv: *mut *mut *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn esx_parse_file(
        filename: *const ::std::os::raw::c_char,
        prog: *mut Esx_Program,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn esx_parse_string(
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct Esx_Token {
    pub type_: Esx_Token__bindgen_ty_1,
    pub next: *mut Esx_Token,
    pub as_: Esx_Token__bindgen_ty_2,
}
pub const Esx_Token_Esx_Atom: Esx_Token__bindgen_ty_1 = 0;
pub const Esx_Token_Esx_String: Esx_Token__bindgen_ty_1 = 1;
pub const Esx_Token_Esx_Intlit: Esx_Token__bindgen_ty_1 = 2;
pub const Esx_Token_Esx_FloatLit: Esx_Token__bindgen_ty_1 = 3;
pub const Esx_Token_Esx_CharLit: Esx_Token__bindgen_ty_1 = 4;
pub const Esx_Token_Esx_Expr: Esx_Token__bindgen_ty_1 = 5;
pub type Esx_Token__bindgen_ty_1 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub union Esx_Token__bindgen_ty_2 {
    pub s: *mut ::std::os::raw::c_char,
    pub c: ::std::os::raw::c_int,
    pub i: ::std::os::raw::c_ulong,
    pub f: f32,
    pub expr: *mut Esx_Program,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Esx_Token__bindgen_ty_2"][::std::mem::size_of::<Esx_Token__bindgen_ty_2>() - 8usize];
    ["Alignment of Esx_Token__bindgen_ty_2"]
        [::std::mem::align_of::<Esx_Token__bindgen_ty_2>() - 8usize];
    ["Offset of field: Esx_Token__bindgen_ty_2::s"]
        [::std::mem::offset_of!(Esx_Token__bindgen_ty_2, s) - 0usize];
    ["Offset of field: Esx_Token__bindgen_ty_2::c"]
        [::std::mem::offset_of!(Esx_Token__bindgen_ty_2, c) - 0usize];
    ["Offset of field: Esx_Token__bindgen_ty_2::i"]
        [::std::mem::offset_of!(Esx_Token__bindgen_ty_2, i) - 0usize];
    ["Offset of field: Esx_Token__bindgen_ty_2::f"]
        [::std::mem::offset_of!(Esx_Token__bindgen_ty_2, f) - 0usize];
    ["Offset of field: Esx_Token__bindgen_ty_2::expr"]
        [::std::mem::offset_of!(Esx_Token__bindgen_ty_2, expr) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Esx_Token"][::std::mem::size_of::<Esx_Token>() - 24usize];
    ["Alignment of Esx_Token"][::std::mem::align_of::<Esx_Token>() - 8usize];
    ["Offset of field: Esx_Token::type_"][::std::mem::offset_of!(Esx_Token, type_) - 0usize];
    ["Offset of field: Esx_Token::next"][::std::mem::offset_of!(Esx_Token, next) - 8usize];
    ["Offset of field: Esx_Token::as_"][::std::mem::offset_of!(Esx_Token, as_) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Esx_Print_Opts {
    pub pretty: bool,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Esx_Print_Opts"][::std::mem::size_of::<Esx_Print_Opts>() - 32usize];
    ["Alignment of Esx_Print_Opts"][::std::mem::align_of::<Esx_Print_Opts>() - 8usize];
    ["Offset of field: Esx_Print_Opts::pretty"]
        [::std::mem::offset_of!(Esx_Print_Opts, pretty) - 0usize];
    ["Offset of field: Esx_Print_Opts::sep"][::std::mem::offset_of!(Esx_Print_Opts, sep) - 8usize];
    ["Offset of field: Esx_Print_Opts::file"]
        [::std::mem::offset_of!(Esx_Print_Opts, file) - 16usize];
    ["Offset of field: Esx_Print_Opts::end"][::std::mem::offset_of!(Esx_Print_Opts, end) - 24usize];
};
unsafe extern "C" {
    pub fn __esx_print_expression(tok: *mut Esx_Token, opts: Esx_Print_Opts);
}
unsafe extern "C" {
    pub fn esx_print_token(
        last: *mut Esx_Token,
...
pub const xkb_rmlvo_builder_flags_XKB_RMLVO_BUILDER_NO_FLAGS: xkb_rmlvo_builder_flags = 0;
pub type xkb_rmlvo_builder_flags = ::std::os::raw::c_uint;
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn xkb_rmlvo_builder_append_layout(
        ...
        variant: *const ::std::os::raw::c_char,
...
pub const xkb_keymap_format_XKB_KEYMAP_FORMAT_TEXT_V2: xkb_keymap_format = 2;
...
pub const xkb_keymap_serialize_flags_XKB_KEYMAP_SERIALIZE_NO_FLAGS: xkb_keymap_serialize_flags = 0;
pub const xkb_keymap_serialize_flags_XKB_KEYMAP_SERIALIZE_PRETTY: xkb_keymap_serialize_flags = 1;
pub const xkb_keymap_serialize_flags_XKB_KEYMAP_SERIALIZE_KEEP_UNUSED: xkb_keymap_serialize_flags =
    2;
pub type xkb_keymap_serialize_flags = ::std::os::raw::c_uint;
unsafe extern "C" {
...
pub const Key_mods_Mod_None: Key_mods = 0;
pub const Key_mods_Mod_Shift_L: Key_mods = 1;
pub const Key_mods_Mod_Shift_R: Key_mods = 2;
pub const Key_mods_Mod_Shift: Key_mods = 3;
pub const Key_mods_Mod_Control_L: Key_mods = 4;
pub const Key_mods_Mod_Control_R: Key_mods = 8;
pub const Key_mods_Mod_Control: Key_mods = 12;
pub const Key_mods_Mod_Caps_Lock: Key_mods = 16;
pub const Key_mods_Mod_Shift_Lock: Key_mods = 32;
pub const Key_mods_Mod_Meta_L: Key_mods = 64;
pub const Key_mods_Mod_Meta_R: Key_mods = 128;
pub const Key_mods_Mod_Meta: Key_mods = 192;
pub const Key_mods_Mod_Alt_L: Key_mods = 256;
pub const Key_mods_Mod_Alt_R: Key_mods = 512;
pub const Key_mods_Mod_Alt: Key_mods = 768;
pub const Key_mods_Mod_Super_L: Key_mods = 1024;
pub const Key_mods_Mod_Super_R: Key_mods = 2048;
pub const Key_mods_Mod_Super: Key_mods = 3072;
pub const Key_mods_Mod_Hyper_L: Key_mods = 4096;
pub const Key_mods_Mod_Hyper_R: Key_mods = 8192;
pub const Key_mods_Mod_Hyper: Key_mods = 12288;
pub type Key_mods = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Keypress {
    pub mods: Key_mods,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Keypress"][::std::mem::size_of::<Keypress>() - 12usize];
    ["Alignment of Keypress"][::std::mem::align_of::<Keypress>() - 4usize];
    ["Offset of field: Keypress::mods"][::std::mem::offset_of!(Keypress, mods) - 0usize];
    ["Offset of field: Keypress::sym"][::std::mem::offset_of!(Keypress, sym) - 4usize];
    ["Offset of field: Keypress::codepoint"][::std::mem::offset_of!(Keypress, codepoint) - 8usize];
};
pub type Keypress_listener = ::std::option::Option<unsafe extern "C" fn(arg1: Keypress)>;
unsafe extern "C" {
    pub fn register_keypress(sym: xkb_keysym_t, mods: Key_mods, codepoint: u32);
}
unsafe extern "C" {
    pub fn add_keypress_listener(arg1: Keypress_listener);
}
unsafe extern "C" {
    pub fn kp_has_mod_Alt(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Alt_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Alt_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Caps_Lock(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Control(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Control_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Control_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Hyper(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Hyper_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Hyper_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Meta(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Meta_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Meta_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Shift(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Shift_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Shift_Lock(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Shift_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Super(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Super_L(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn kp_has_mod_Super_R(kp: Keypress) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Alt(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Alt_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Alt_R(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Caps_Lock(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Control(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Control_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Control_R(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Hyper(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Hyper_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Hyper_R(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Meta(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Meta_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Meta_R(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Shift(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Shift_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Shift_Lock(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Shift_R(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Super(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Super_L(mods: ::std::os::raw::c_int) -> bool;
}
unsafe extern "C" {
    pub fn mod_has_Super_R(mods: ::std::os::raw::c_int) -> bool;
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct Pointer_Event {
    pub type_: Pointer_Event__bindgen_ty_1,
    pub __bindgen_anon_1: Pointer_Event__bindgen_ty_2,
    pub __bindgen_anon_2: Pointer_Event__bindgen_ty_3,
}
pub const Pointer_Event_Pointer_Move: Pointer_Event__bindgen_ty_1 = 0;
pub const Pointer_Event_Pointer_Press: Pointer_Event__bindgen_ty_1 = 1;
pub const Pointer_Event_Pointer_Release: Pointer_Event__bindgen_ty_1 = 2;
pub const Pointer_Event_Pointer_Enter: Pointer_Event__bindgen_ty_1 = 3;
pub const Pointer_Event_Pointer_Leave: Pointer_Event__bindgen_ty_1 = 4;
pub const Pointer_Event_Pointer_Scroll: Pointer_Event__bindgen_ty_1 = 5;
pub const Pointer_Event_Pointer_Scroll_Relative: Pointer_Event__bindgen_ty_1 = 6;
pub type Pointer_Event__bindgen_ty_1 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub union Pointer_Event__bindgen_ty_2 {
    pub btn: ::std::os::raw::c_int,
    pub scroll: ::std::os::raw::c_int,
    pub __bindgen_anon_1: Pointer_Event__bindgen_ty_2__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Pointer_Event__bindgen_ty_2__bindgen_ty_1 {
    pub axis: ::std::os::raw::c_int,
    pub direction: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Pointer_Event__bindgen_ty_2__bindgen_ty_1"]
        [::std::mem::size_of::<Pointer_Event__bindgen_ty_2__bindgen_ty_1>() - 8usize];
    ["Alignment of Pointer_Event__bindgen_ty_2__bindgen_ty_1"]
        [::std::mem::align_of::<Pointer_Event__bindgen_ty_2__bindgen_ty_1>() - 4usize];
    ["Offset of field: Pointer_Event__bindgen_ty_2__bindgen_ty_1::axis"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_2__bindgen_ty_1, axis) - 0usize];
    ["Offset of field: Pointer_Event__bindgen_ty_2__bindgen_ty_1::direction"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_2__bindgen_ty_1, direction) - 4usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Pointer_Event__bindgen_ty_2"]
        [::std::mem::size_of::<Pointer_Event__bindgen_ty_2>() - 8usize];
    ["Alignment of Pointer_Event__bindgen_ty_2"]
        [::std::mem::align_of::<Pointer_Event__bindgen_ty_2>() - 4usize];
    ["Offset of field: Pointer_Event__bindgen_ty_2::btn"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_2, btn) - 0usize];
    ["Offset of field: Pointer_Event__bindgen_ty_2::scroll"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_2, scroll) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Pointer_Event__bindgen_ty_3 {
    pub x: ::std::os::raw::c_int,
    pub y: ::std::os::raw::c_int,
    pub px: ::std::os::raw::c_int,
    pub py: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Pointer_Event__bindgen_ty_3"]
        [::std::mem::size_of::<Pointer_Event__bindgen_ty_3>() - 16usize];
    ["Alignment of Pointer_Event__bindgen_ty_3"]
        [::std::mem::align_of::<Pointer_Event__bindgen_ty_3>() - 4usize];
    ["Offset of field: Pointer_Event__bindgen_ty_3::x"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_3, x) - 0usize];
    ["Offset of field: Pointer_Event__bindgen_ty_3::y"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_3, y) - 4usize];
    ["Offset of field: Pointer_Event__bindgen_ty_3::px"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_3, px) - 8usize];
    ["Offset of field: Pointer_Event__bindgen_ty_3::py"]
        [::std::mem::offset_of!(Pointer_Event__bindgen_ty_3, py) - 12usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Pointer_Event"][::std::mem::size_of::<Pointer_Event>() - 28usize];
    ["Alignment of Pointer_Event"][::std::mem::align_of::<Pointer_Event>() - 4usize];
    ["Offset of field: Pointer_Event::type_"]
        [::std::mem::offset_of!(Pointer_Event, type_) - 0usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
pub struct Event {
    pub code: Event__bindgen_ty_1,
    pub __bindgen_anon_1: Event__bindgen_ty_2,
}
pub const Event_EventKp: Event__bindgen_ty_1 = 0;
pub const Event_EventPointer: Event__bindgen_ty_1 = 1;
pub type Event__bindgen_ty_1 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub union Event__bindgen_ty_2 {
    pub kp: Keypress,
    pub pointer: Pointer_Event,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Event__bindgen_ty_2"][::std::mem::size_of::<Event__bindgen_ty_2>() - 28usize];
    ["Alignment of Event__bindgen_ty_2"][::std::mem::align_of::<Event__bindgen_ty_2>() - 4usize];
    ["Offset of field: Event__bindgen_ty_2::kp"]
        [::std::mem::offset_of!(Event__bindgen_ty_2, kp) - 0usize];
    ["Offset of field: Event__bindgen_ty_2::pointer"]
        [::std::mem::offset_of!(Event__bindgen_ty_2, pointer) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Event"][::std::mem::size_of::<Event>() - 32usize];
    ["Alignment of Event"][::std::mem::align_of::<Event>() - 4usize];
    ["Offset of field: Event::code"][::std::mem::offset_of!(Event, code) - 0usize];
};
unsafe extern "C" {
    pub fn event_is_kp(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_get_sym(e: Event) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn event_kp_get_mods(e: Event) -> ::std::os::raw::c_int;
}
pub type Resize_Listener = ::std::option::Option<
    unsafe extern "C" fn(
...
>;
unsafe extern "C" {
    pub fn add_resize_listener(rl: Resize_Listener);
}
unsafe extern "C" {
    pub fn notify_resize_event(
        x: ::std::os::raw::c_int,
        y: ::std::os::raw::c_int,
        w: ::std::os::raw::c_int,
        h: ::std::os::raw::c_int,
...
pub type Pointer_Listener = ::std::option::Option<unsafe extern "C" fn(arg1: Pointer_Event)>;
unsafe extern "C" {
    pub fn add_pointer_listener(pl: Pointer_Listener);
}
unsafe extern "C" {
    pub fn notify_pointer_event(arg1: Pointer_Event);
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Alt(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Control(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Hyper(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Meta(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Shift(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Super(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Alt_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Alt_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Caps_Lock(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Control_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Control_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Hyper_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Hyper_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Meta_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Meta_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Shift_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Shift_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Super_L(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Super_R(e: Event) -> bool;
}
unsafe extern "C" {
    pub fn event_kp_has_mod_Shift_Lock(e: Event) -> bool;
}
...
unsafe extern "C" {
    pub fn create_fullscreen_window() -> *mut Window;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn window_setall(window: *mut Window, c: u32, fg: u32, bg: u32);
}
unsafe extern "C" {
    pub fn window_puts(
        window: *mut Window,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct WindowSharedBuffer {
    pub buffer: *mut Char3,
    pub capacity: usize,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Char3"][::std::mem::size_of::<Char3>() - 12usize];
    ["Alignment of Char3"][::std::mem::align_of::<Char3>() - 4usize];
    ["Offset of field: Char3::cp"][::std::mem::offset_of!(Char3, cp) - 0usize];
    ["Offset of field: Char3::fg"][::std::mem::offset_of!(Char3, fg) - 4usize];
    ["Offset of field: Char3::bg"][::std::mem::offset_of!(Char3, bg) - 8usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of WindowSharedBuffer"][::std::mem::size_of::<WindowSharedBuffer>() - 24usize];
    ["Alignment of WindowSharedBuffer"][::std::mem::align_of::<WindowSharedBuffer>() - 8usize];
    ["Offset of field: WindowSharedBuffer::buffer"]
        [::std::mem::offset_of!(WindowSharedBuffer, buffer) - 0usize];
    ["Offset of field: WindowSharedBuffer::capacity"]
        [::std::mem::offset_of!(WindowSharedBuffer, capacity) - 8usize];
    ["Offset of field: WindowSharedBuffer::gap"]
        [::std::mem::offset_of!(WindowSharedBuffer, gap) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Window {
    ...
    pub shared: *mut WindowSharedBuffer,
    pub parent: *mut Window,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Window"][::std::mem::size_of::<Window>() - 32usize];
    ["Alignment of Window"][::std::mem::align_of::<Window>() - 8usize];
    ["Offset of field: Window::x"][::std::mem::offset_of!(Window, x) - 0usize];
    ["Offset of field: Window::y"][::std::mem::offset_of!(Window, y) - 4usize];
    ["Offset of field: Window::w"][::std::mem::offset_of!(Window, w) - 8usize];
    ["Offset of field: Window::h"][::std::mem::offset_of!(Window, h) - 12usize];
    ["Offset of field: Window::shared"][::std::mem::offset_of!(Window, shared) - 16usize];
    ["Offset of field: Window::parent"][::std::mem::offset_of!(Window, parent) - 24usize];
};
pub type Plugin = ::std::os::raw::c_void;
unsafe extern "C" {
    pub fn plug_run(
        plugpath: *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn plug_send_kp_event(
        p: *mut Plugin,
        sym: ::std::os::raw::c_int,
        mods: ::std::os::raw::c_int,
    );
}
unsafe extern "C" {
    pub fn plug_send_resize_event(
        p: *mut Plugin,
        x: ::std::os::raw::c_int,
        y: ::std::os::raw::c_int,
        w: ::std::os::raw::c_int,
...
unsafe extern "C" {
    pub fn plug_send_pointer_event(p: *mut Plugin, arg1: Pointer_Event);
}
unsafe extern "C" {
    pub fn send_resize_event();
}
unsafe extern "C" {
    pub fn plug_replace_img(current: *mut Plugin, plugpath: *mut ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn plug_render(p: *mut Plugin);
}
unsafe extern "C" {
    pub fn ask_for_redraw();
}
unsafe extern "C" {
    pub fn listen_to_fd(fd: ::std::os::raw::c_int);
}
unsafe extern "C" {
    pub fn window_clear(window: *mut Window, fg: u32, bg: u32);
}
unsafe extern "C" {
    pub fn window_clear_line(window: *mut Window, line: ::std::os::raw::c_int, fg: u32, bg: u32);
}
unsafe extern "C" {
    pub fn fb_capture(filename: *mut ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn symbol_register(
